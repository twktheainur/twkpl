...
class NoeudProgramme : public Noeud
{
	...
	public:
		...
		inline string getType(){return "<ENTIER>";}//Toujours entier, c'est la "valeur de retour du programme"

		~NoeudProgramme()
		{
		} // à cause du destructeur virtuel de la classe Noeud
		Type * getValeur(); // évalue chaque declaration
		void afficher(unsigned short indentation = 0); // affiche les declarations
		void ajouteInstruction(Noeud * instruction); // adding a declaration to the sequence
...
class NoeudSeqInst : public Noeud
{
	...
	public:
		...
		inline string getType(){return "<ENTIER>";}//PAr convetion, le nombre d'instructions
		~NoeudSeqInst()
		{
		} // à cause du destructeur virtuel de la classe Noeud
...
{
	// classe pour représenter un noeud "sequence dde declarations"
	public:
		NoeudDeclaration();
		...
		inline string getType(){return "<ENTIER>";}//Idem que pour seqInst
		Type * getValeur(); // Declare chaque variable dans la table
		void afficher(unsigned short indentation = 0); // affiche la séquence de declarations
		void ajouteDeclaration(string symbolName, string type); // ajoute une declaration à la séquence
...
class NoeudAffectation : public Noeud
{
	...
	public:
		...
		//Verification de la semantique de l'affectation
		//Retourne le type commun aux 2 operandes
...
class NoeudOperateurBinaire : public Noeud
{
	...
	public:
		...
		inline string getType()//Verification de la semantique de l'operateur binaire
		//Retourne le type commun aux 2 operandes
		{
			if(operandeDroit->getType()!=operandeGauche->getType())
				throw new ExTypeMismatch(operandeDroit->getType(),operandeGauche->getType());
...
class NoeudSi : public Noeud
{
	public:
		...
		inline string getType()
		{
			if(condition->getType()!="<ENTIER>")
				throw ExTypeMismatch(condition->getType(),"<ENTIER>");
...
class NoeudEcrireln : public Noeud
{
	public:
		NoeudEcrireln(Noeud *facteur);
		~NoeudEcrireln()
		{
		}
		inline string getType()
